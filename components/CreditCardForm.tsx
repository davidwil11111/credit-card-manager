      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6 pb-20">
        <section className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-xs text-gray-500 mb-1">持卡�?/label>
              <input 
                type="text"
            ...
            <div>
              ...
              <input list="bank-list" type="text" value={formData.bankName} onChange={(e) => handleChange('bankName', e.target.value)} className={`w-full p-2 rounded-lg border bg-gray-50 ${errors.bankName ? 'border-red-500' : 'border-gray-200'}`} placeholder="选择或输�? />
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    <label className="block text-xs text-gray-500 mb-1">账单�?/label>
                    <select value={formData.billDay} onChange={(e) => handleChange('billDay', parseInt(e.target.value))} className="w-full p-2 rounded-lg border border-gray-200 bg-gray-50">
                        {Array.from({length: 31}, (_, i) => i + 1).map(d => <option key={d} value={d}>每月 {d} �?/option>)}
                    </select>
                </div>
                <div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-200">
                <label className="block text-xs text-gray-500 mb-2">还款日设�?/label>
                <div className="flex flex-col gap-3">
                    ...
                    <label className="flex items-center gap-2">
                        ...
                        <span className="text-sm">账单日后 N �?/span>
