...
import { generateBillingCycles } from '../utils/billing';
import { getBankDetailGradient, getBankColor, isTempLimitValid } from '../constants';
  ...
  return (
    <div className="flex flex-col h-full bg-[#fdf7ff]">
      ...
      <div className="fixed bottom-10 right-6 flex flex-col items-center gap-1 z-50">
        ...
        <span className="text-[10px] font-medium" style={{color:bankColor}}>记一�?/span>
      </div>
